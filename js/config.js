...
window.MiniTalkConfig={
  version:"3.30.0-moaru-clean-namespace",
  appName:"모아루",
  ...
  paths:{rooms:"rooms",globalMessages:"socialChat",roomMessages:"socialChatRooms",presence:"moaru/v3/presence",commands:"moaru/v3/commands",tasks:"moaru/v3/tasks",profiles:"moaru/v3/profiles",shopInventory:"moaru/v3/shop/inventory"},
