...
window.MiniTalkConfig={
  version:"3.21.0-firebase-source-sheet-backup",
  appName:"미니톡",
  ...
  paths:{rooms:"mini_talk/v3/rooms",messages:"mini_talk/v3/messages",presence:"mini_talk/v3/presence",commands:"mini_talk/v3/commands",tasks:"mini_talk/v3/tasks",profiles:"mini_talk/v3/profiles",shopInventory:"mini_talk/v3/shop/inventory"},
