...
MiniTalk.Features.Feed=(()=>{
  ...
  async function createPost(text,media){
    const u=user(),id=crypto.randomUUID(),createdAt=Date.now(),meta={id,user_id:u.user_id,nickname:u.nickname,text:String(text||"").slice(0,180),mediaType:media?.type||"",createdAt,updatedAt:createdAt,heartCount:0,hearts:{}};
