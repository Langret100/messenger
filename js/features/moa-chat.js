...
MiniTalk.Features.MoaChat=(()=>{
  ...
  async function render(host){
    ...
    starterRows.forEach(({label,prompt})=>{const chip=Dom.el("button",{class:"moa-suggestion-chip",type:"button",text:label,"aria-label":prompt});chip.onclick=()=>{input.value=prompt;form.requestSubmit?.()||send.click()};suggestions.append(chip)});
