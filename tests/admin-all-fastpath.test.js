...
// 변경 에셋 캐시 버전 동기화
for(const ref of ['js/adapters/realtime.js?v=64.5.42','js/shopping/store-service.js?v=64.5.24','js/tasks/task-service.js?v=64.5.26','js/features/admin.js?v=64.5.38'])ok(index.includes(ref),'cache ref missing '+ref);
