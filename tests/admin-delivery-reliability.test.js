...
ok(auth.includes('error.code = "REQUEST_TIMEOUT"')&&auth.includes('SHOP_MANAGER_PERMISSION_REQUIRED')&&auth.includes('totalBudgetMs = Math.min(7000'), 'client timeout/auth diagnostics missing');
