...
if(!service.includes("notifyGift")||!service.includes("inventoryDirty=true")||!service.includes("setInterval(()=>refreshInventory(true).catch(()=>{}),15000)"))throw new Error("gift notification / Apps Script inventory safety policy is incomplete");
