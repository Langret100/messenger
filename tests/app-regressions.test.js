...
if(!service.includes("notifyGift")||!service.includes("inventoryDirty=true")||!service.includes("SHOP_DELIVERY_COMPLETED")||service.includes("setInterval(()=>refreshInventory(true).catch(()=>{}),15000)"))throw new Error("gift/delivery signal-driven inventory policy is incomplete");
...
console.log("APP_REGRESSIONS_OK");
