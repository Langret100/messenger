...
ok(html.includes('face-toy.css?v=4')&&html.includes('lookalike-play.css?v=3')&&html.includes('game-community.css?v=19')&&html.includes('tools.js?v=64.5.10'),'cache refs stale');
