...
ok(html.indexOf('window.opener')<html.indexOf('css/tokens.css?v=7'),'theme bootstrap must run before token CSS');
...
ok(html.includes('js/tools/camera-tool.js?v=2'),'camera bootstrap cache-bust must advance');
