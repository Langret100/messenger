...
ok(html.includes('js/ui/drag-scroll.js?v='),'drag-scroll v3 cache ref missing');
ok(html.includes('js/features/chats.js?v='),'chats cache ref stale');
ok(html.includes('js/features/tasks.js?v='),'tasks cache ref stale');
