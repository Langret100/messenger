...
assert(index.includes('js/features/tools.js?v=64.5.15'),'tools cache-bust stale');
assert(sw.includes('moaru-moa-admin-isolation-url-filter-v10'),'service worker cache stale');
