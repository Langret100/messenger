...
assert(index.includes('js/features/tools.js?v=64.5.9'),'tools cache-bust stale');
assert(sw.includes('moaru-face-play-facechange-drag'),'service worker cache stale');
