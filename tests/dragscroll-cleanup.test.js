...
assert(index.includes('js/features/tools.js?v=64.5.11'),'tools cache-bust stale');
assert(sw.includes('moaru-camera-popup-task-scroll-fix'),'service worker cache stale');
