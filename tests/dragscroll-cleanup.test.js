...
assert(index.includes('js/features/tools.js?v=64.5.10'),'tools cache-bust stale');
assert(sw.includes('moaru-camera-play-popup-polish'),'service worker cache stale');
