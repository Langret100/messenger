...
ok(html.indexOf('js/tools/face-toy.js?v=6')<html.indexOf('js/tools/lookalike-play.js?v=4')&&html.indexOf('js/tools/lookalike-play.js?v=4')<html.indexOf('js/features/tools.js?v=64.5.13'),'face toy module must load before tools feature');
