...
ok(feed.includes('MiniTalk.UI.Shell.setHeader("소식",[headerHeartBadge()]);ensureSub();'),'feed header must exist before total-heart subscription starts');
ok(html.includes('js/features/feed.js?v=65.0.12'),'feed cache version stale');
ok(app.includes('sw.js?v=64.5.43')&&sw.includes('moaru-v64.5.43-feed-heart-state-audio-reward-20260820'),'service worker cache version stale');
