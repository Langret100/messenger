...
ok(html.includes('js/features/feed.js?v='),'feed cache version stale');
ok(app.includes('sw.js?v=')&&sw.includes('moaru-runtime-bundle-'),'service worker cache version stale');
