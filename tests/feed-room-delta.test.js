...
ok(html.includes('feed-classinfo-weekly.css?v=')&&html.includes('realtime.js?v=')&&html.includes('features/chats.js?v=')&&html.includes('features/feed.js?v=')&&html.includes('app.js?v='),"delta patch cache versions stale");
ok(sw.includes('moaru-runtime-bundle-')&&app.includes('sw.js?v='),"service worker cache bump missing");
