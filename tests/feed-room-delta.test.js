...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.18')&&html.includes('realtime.js?v=64.5.37')&&html.includes('features/chats.js?v=64.5.17')&&html.includes('features/feed.js?v=65.0.16')&&html.includes('app.js?v=64.5.34'),"delta patch cache versions stale");
