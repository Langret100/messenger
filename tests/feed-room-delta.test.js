...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.31')&&html.includes('realtime.js?v=64.5.42')&&html.includes('features/chats.js?v=64.5.21')&&html.includes('features/feed.js?v=65.0.21')&&html.includes('app.js?v=64.5.43'),"delta patch cache versions stale");
ok(sw.includes('moaru-moa-admin-isolation-url-filter-v10')&&app.includes('sw.js?v=64.5.57'),"service worker cache bump missing");
