...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.31')&&html.includes('realtime.js?v=64.5.45')&&html.includes('features/chats.js?v=64.5.24')&&html.includes('features/feed.js?v=65.0.21')&&html.includes('app.js?v=64.5.46'),"delta patch cache versions stale");
