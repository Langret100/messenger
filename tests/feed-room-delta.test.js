...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.31')&&html.includes('realtime.js?v=64.5.53')&&html.includes('features/chats.js?v=64.5.28')&&html.includes('features/feed.js?v=65.0.21')&&html.includes('app.js?v=64.5.47'),"delta patch cache versions stale");
ok(sw.includes('moaru-runtime-bundle-2')&&app.includes('sw.js?v=64.5.61'),"service worker cache bump missing");
