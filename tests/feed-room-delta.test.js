...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.23')&&html.includes('realtime.js?v=64.5.37')&&html.includes('features/chats.js?v=64.5.21')&&html.includes('features/feed.js?v=65.0.19')&&html.includes('app.js?v=64.5.36'),"delta patch cache versions stale");
ok(sw.includes('moaru-v64.5.50-interaction-weather-popup-v91-20260821')&&app.includes('sw.js?v=64.5.48'),"service worker cache bump missing");
