...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.30')&&html.includes('realtime.js?v=64.5.38')&&html.includes('features/chats.js?v=64.5.21')&&html.includes('features/feed.js?v=65.0.21')&&html.includes('app.js?v=64.5.37'),"delta patch cache versions stale");
