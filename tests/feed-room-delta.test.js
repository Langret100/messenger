...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.17')&&html.includes('realtime.js?v=64.5.36')&&html.includes('features/chats.js?v=64.5.16')&&html.includes('features/feed.js?v=65.0.14')&&html.includes('app.js?v=64.5.34'),"delta patch cache versions stale");
