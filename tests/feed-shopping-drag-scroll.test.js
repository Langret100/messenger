...
ok(html.includes('js/ui/drag-scroll.js?v='),'drag-scroll helper missing');
ok(html.includes('feed.js?v=')&&html.includes('shopping.js?v=')&&html.includes('shopping-store.css?v='),'drag-scroll cache versions stale');
