...
ok(html.includes('js/ui/drag-scroll.js?v=2'),'drag-scroll helper missing');
ok(html.includes('feed.js?v=65.0.18')&&html.includes('shopping.js?v=64.5.27')&&html.includes('shopping-store.css?v=64.5.10'),'drag-scroll cache versions stale');
