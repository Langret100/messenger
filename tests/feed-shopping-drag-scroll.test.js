...
ok(html.includes('js/ui/drag-scroll.js?v=10'),'drag-scroll helper missing');
ok(html.includes('feed.js?v=65.0.21')&&html.includes('shopping.js?v=64.5.29')&&html.includes('shopping-store.css?v=64.5.11'),'drag-scroll cache versions stale');
