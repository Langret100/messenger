...
for(const ref of ['data-cache.js?v=64.5.25','realtime.js?v=64.5.53','attachments.js?v=65.0.1','chats.js?v=64.5.28','feed.js?v=65.0.21','profile-editor.js?v=64.4.2'])ok(html.includes(ref),`cache version missing: ${ref}`);
ok(sw.includes('moaru-runtime-bundle-2')&&app.includes('sw.js?v=64.5.61'),'service worker version missing');
