...
for(const ref of ['data-cache.js?v=64.5.24','realtime.js?v=64.5.45','attachments.js?v=65.0.1','chats.js?v=64.5.23','feed.js?v=65.0.21','profile-editor.js?v=64.4.2'])ok(html.includes(ref),`cache version missing: ${ref}`);
