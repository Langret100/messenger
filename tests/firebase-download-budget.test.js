...
for(const ref of ['data-cache.js?v=64.5.24','realtime.js?v=64.5.37','attachments.js?v=65.0.1','chats.js?v=64.5.17','feed.js?v=65.0.15','profile-editor.js?v=64.4.2'])ok(html.includes(ref),`cache version missing: ${ref}`);
