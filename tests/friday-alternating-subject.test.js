...
ok(src.includes('`${subject} 20문항 · 80점 이상 🪙 +${REWARD_COIN}`'),'weekly reward summary copy missing');
...
const html=fs.readFileSync(path.join(root,'index.html'),'utf8');ok(html.includes('friday-grade6-mission.js?v=65.0.16'),'Friday mission cache version stale');
