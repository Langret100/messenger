...
ok(src.includes('previous6=version==="v6"')&&src.includes('"v7"')&&src.includes('shuffle(cats,r)'),'weekly randomized worksheet generator missing');
...
ok(html.includes('friday-grade6-mission.js?v=65.0.21')&&html.includes('feed-classinfo-weekly.css?v=65.0.31'),'worksheet cache bust missing');
