...
ok(src.includes('questions.filter(q=>selections[q.id]==null)')&&src.includes('제출 전에는 답을 바꿀 수 있습니다.'),'worksheet all-answer submit guard/edit-before-submit missing');
ok(src.includes('saveDraft(questions,selections)')&&src.includes('scheduleDraftSave'),'worksheet draft autosave missing');
ok(src.includes('grade6-worksheet-v4')&&src.includes('shuffle(cats,r)'),'weekly randomized worksheet generator missing');
...
ok(html.includes('friday-grade6-mission.js?v=65.0.9')&&html.includes('feed-classinfo-weekly.css?v=65.0.20'),'worksheet cache bust missing');
