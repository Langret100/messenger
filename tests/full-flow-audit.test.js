...
for(const ref of ['js/core/user-directory.js?v=','js/adapters/auth-api.js?v=','js/adapters/realtime.js?v=','js/economy/coin-wallet.js?v=','js/shopping/store-service.js?v=','js/tasks/task-service.js?v=','js/tasks/task-window.js?v=','js/features/shopping.js?v=','js/features/admin.js?v=','js/app.js?v='])ok(html.includes(ref),`stale audited asset version: ${ref}`);
