...
for(const ref of ['js/core/user-directory.js?v=64.5.8','js/adapters/auth-api.js?v=64.5.8','js/adapters/realtime.js?v=64.5.12','js/economy/coin-wallet.js?v=64.5.8','js/shopping/store-service.js?v=64.5.8','js/tasks/task-service.js?v=64.5.8','js/tasks/task-window.js?v=64.5.8','js/features/shopping.js?v=64.5.8','js/features/admin.js?v=64.5.8','js/app.js?v=64.5.11'])ok(html.includes(ref),`stale audited asset version: ${ref}`);
