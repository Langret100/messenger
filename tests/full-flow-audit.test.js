...
for(const ref of ['js/core/user-directory.js?v=64.5.8','js/adapters/auth-api.js?v=64.5.31','js/adapters/realtime.js?v=64.5.37','js/economy/coin-wallet.js?v=64.5.9','js/shopping/store-service.js?v=64.5.14','js/tasks/task-service.js?v=64.5.25','js/tasks/task-window.js?v=64.5.8','js/features/shopping.js?v=64.5.27','js/features/admin.js?v=64.5.26','js/app.js?v=64.5.36'])ok(html.includes(ref),`stale audited asset version: ${ref}`);
