...
for(const ref of ['js/core/user-directory.js?v=64.5.8','js/adapters/auth-api.js?v=64.5.39','js/adapters/realtime.js?v=64.5.42','js/economy/coin-wallet.js?v=64.5.9','js/shopping/store-service.js?v=64.5.22','js/tasks/task-service.js?v=64.5.26','js/tasks/task-window.js?v=64.5.10','js/features/shopping.js?v=64.5.35','js/features/admin.js?v=64.5.36','js/app.js?v=64.5.42'])ok(html.includes(ref),`stale audited asset version: ${ref}`);
