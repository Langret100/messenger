...
for(const ref of ['js/core/user-directory.js?v=64.5.9','js/adapters/auth-api.js?v=64.5.40','js/adapters/realtime.js?v=64.5.45','js/economy/coin-wallet.js?v=64.5.10','js/shopping/store-service.js?v=64.5.25','js/tasks/task-service.js?v=64.5.26','js/tasks/task-window.js?v=64.5.10','js/features/shopping.js?v=64.5.42','js/features/admin.js?v=64.5.38','js/app.js?v=64.5.46'])ok(html.includes(ref),`stale audited asset version: ${ref}`);
