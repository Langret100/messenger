...
ok(index.includes('js/features/games.js?v='),'games feature cache version stale');
ok(index.includes('js/games/score-service.js?v='),'score service cache version stale');
