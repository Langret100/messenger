...
if(shop.includes("setInterval(()=>refreshInventory(true).catch(()=>{}),15000)")||!shop.includes("SHOP_DELIVERY_COMPLETED"))throw new Error("shopping still uses 15-second polling instead of command-driven refresh");
