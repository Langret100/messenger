...
ok(html.includes('css/app.css?v=64.5.13')&&html.includes('feed-classinfo-weekly.css?v=65.0.31')&&html.includes('realtime.js?v=64.5.42')&&html.includes('features/chats.js?v=64.5.21')&&html.includes('app.js?v=64.5.37'),'v5.22 cache versions stale');
ok(sw.includes('moaru-camera-popup-task-scroll-fix')&&app.includes('sw.js?v=64.5.51'),'v5.22 service worker version stale');
