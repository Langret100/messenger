...
ok(html.includes('css/app.css?v=')&&html.includes('feed-classinfo-weekly.css?v=')&&html.includes('realtime.js?v=')&&html.includes('features/chats.js?v=')&&html.includes('app.js?v='),'v5.22 cache versions stale');
ok(sw.includes('moaru-runtime-bundle-')&&app.includes('sw.js?v='),'v5.22 service worker version stale');
