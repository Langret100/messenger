...
ok(html.includes('css/app.css?v=64.5.11')&&html.includes('feed-classinfo-weekly.css?v=65.0.18')&&html.includes('realtime.js?v=64.5.37')&&html.includes('features/chats.js?v=64.5.19')&&html.includes('app.js?v=64.5.34'),'v5.22 cache versions stale');
ok(sw.includes('moaru-v64.5.46-profile-15kb-20260820')&&app.includes('sw.js?v=64.5.46'),'v5.22 service worker version stale');
