...
ok(html.includes('css/app.css?v=64.5.12')&&html.includes('feed-classinfo-weekly.css?v=65.0.25')&&html.includes('realtime.js?v=64.5.38')&&html.includes('features/chats.js?v=64.5.21')&&html.includes('app.js?v=64.5.37'),'v5.22 cache versions stale');
ok(sw.includes('moaru-v64.5.62-admin-fastpath-v104-20260821')&&app.includes('sw.js?v=64.5.49'),'v5.22 service worker version stale');
