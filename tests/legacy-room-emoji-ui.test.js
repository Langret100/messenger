...
ok(rt.includes('function publishRooms(){emit("rooms",{...(roomListRequested?roomDirectoryCache:roomsCache)})}'),'member/group room cache publishing missing');
...
ok(feedcss.includes('bottom:calc(-12px + 58px'),'feed FAB was not lowered further');
ok(html.includes('css/app.css?v=64.5.9')&&html.includes('feed-classinfo-weekly.css?v=65.0.11')&&html.includes('realtime.js?v=64.5.30')&&html.includes('features/chats.js?v=64.5.14')&&html.includes('app.js?v=64.5.31'),'v5.22 cache versions stale');
ok(sw.includes('moaru-v64.5.31-room-summary-mobile-chrome-20260819')&&app.includes('sw.js?v=64.5.31'),'v5.22 service worker version stale');
