...
ok(html.includes('js/features/auth.js?v=64.5.35')&&html.includes('js/ui/shell.js?v=64.5.31')&&html.includes('js/app.js?v=64.5.37'),'login first-paint asset versions stale');
ok(app.includes('sw.js?v=64.5.49')&&sw.includes('moaru-v64.5.59-admin-delivery-reliability-v100-20260821'),'login first-paint service worker version stale');
