...
ok(html.includes('js/features/auth.js?v=64.5.34')&&html.includes('js/ui/shell.js?v=64.5.30')&&html.includes('js/app.js?v=64.5.33'),'login first-paint asset versions stale');
ok(app.includes('sw.js?v=64.5.35')&&sw.includes('moaru-v64.5.35-pip-auth-feed-youtube-20260820'),'login first-paint service worker version stale');
