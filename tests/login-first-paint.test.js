...
ok(html.includes('js/features/auth.js?v=64.5.35')&&html.includes('js/ui/shell.js?v=64.5.32')&&html.includes('js/app.js?v=64.5.37'),'login first-paint asset versions stale');
ok(app.includes('sw.js?v=64.5.50')&&sw.includes('moaru-tools-scroll-layout'),'login first-paint service worker version stale');
