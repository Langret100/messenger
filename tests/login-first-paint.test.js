...
ok(html.includes('js/features/auth.js?v=64.5.33')&&html.includes('js/ui/shell.js?v=64.5.29')&&html.includes('js/app.js?v=64.5.33'),'login first-paint asset versions stale');
ok(app.includes('sw.js?v=64.5.33')&&sw.includes('moaru-v64.5.33-pip-session-idle-cache-20260819'),'login first-paint service worker version stale');
