...
ok(html.includes('js/features/auth.js?v=64.5.35')&&html.includes('js/ui/shell.js?v=64.5.34')&&html.includes('js/app.js?v=64.5.43'),'login first-paint asset versions stale');
ok(app.includes('sw.js?v=64.5.57')&&sw.includes('moaru-moa-admin-isolation-url-filter-v10'),'login first-paint service worker version stale');
