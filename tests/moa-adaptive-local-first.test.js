...
ok(html.includes('js/ai/moa-communication-engine.js?v=35')&&!html.includes('moa-dialogue-core.js')&&!html.includes('moa-chat-engine.js'),'v87 compatibility engine asset mismatch');
