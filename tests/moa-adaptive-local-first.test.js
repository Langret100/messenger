...
ok(html.includes('js/ai/moa-communication-engine.js?v=29')&&!html.includes('moa-dialogue-core.js')&&!html.includes('moa-chat-engine.js'),'v87 compatibility engine asset mismatch');
ok(sw.includes('moaru-moa-admin-isolation-url-filter-v10')&&sw.includes('./js/ai/moa-communication-engine.js'),'v87 compatibility SW asset mismatch');
