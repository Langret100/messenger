...
ok(html.includes('moa-communication-engine.js?v=48'),'v89 cache bust missing');
...
(async()=>{const e=sandbox.MiniTalk.AI.MoaCommunicationEngine;await e.sync(true);
 ...
 const snap=e.debugSnapshot();ok(snap.version===94&&snap.state.phase,'v89 state/version missing');
