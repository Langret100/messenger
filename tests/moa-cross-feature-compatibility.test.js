...
ok(html.includes('auth-api.js?v=64.5.39')&&html.includes('moa-communication-engine.js?v=29')&&html.includes('admin.js?v=64.5.37'),'V6 browser cache busts missing');
ok(app.includes('sw.js?v=64.5.57')&&html.includes('js/app.js?v=64.5.43')&&sw.includes('moaru-moa-admin-isolation-url-filter-v10'),'V6 service worker/app cache chain missing');
