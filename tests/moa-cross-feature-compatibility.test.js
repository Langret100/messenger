...
ok(html.includes('auth-api.js?v=64.5.39')&&html.includes('moa-communication-engine.js?v=29')&&html.includes('admin.js?v=64.5.36'),'V6 browser cache busts missing');
ok(app.includes('sw.js?v=64.5.56')&&html.includes('js/app.js?v=64.5.42')&&sw.includes('moaru-moa-performance-audit-v9'),'V6 service worker/app cache chain missing');
