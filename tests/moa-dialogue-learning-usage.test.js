...
ok(html.includes('moa-communication-engine.js?v='),'engine cache bust missing');
ok(html.includes('js/app.js?v=')&&app.includes('sw.js?v=')&&sw.includes('moaru-runtime-bundle-'),'cache chain missing');
