...
ok(html.includes('moa-communication-engine.js?v=49'),'v88 cache bust missing');
...
(async()=>{const e=sandbox.MiniTalk.AI.MoaCommunicationEngine;await e.sync(true);
 ...
 const snap=e.debugSnapshot();ok(snap.version===94&&Array.isArray(snap.state.strategyHistory),'v88 debug/state missing');
