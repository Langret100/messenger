...
ok(html.includes('moa-chat.css?v=6')&&html.includes('moa-communication-engine.js?v=50')&&html.includes('moa-chat.js?v=14'),'v90 cache bust missing');
ok(sw.includes('moaru-runtime-bundle-2'),'v90 service worker cache missing');
