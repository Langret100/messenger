...
ok(html.includes('moa-chat.css?v=6')&&html.includes('moa-communication-engine.js?v=47')&&html.includes('moa-chat.js?v=14'),'v90 cache bust missing');
...
(async()=>{const e=sandbox.MiniTalk.AI.MoaCommunicationEngine;await e.sync(true);
 ...
 let snap=e.debugSnapshot();ok(snap.version===94&&snap.state.openLoops.length>=1&&typeof snap.profile.initiative==='number','v90 engagement state missing');
