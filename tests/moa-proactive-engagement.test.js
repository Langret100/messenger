...
ok(html.includes('moa-chat.css?v=')&&html.includes('moa-communication-engine.js?v=')&&html.includes('moa-chat.js?v='),'v90 cache bust missing');
ok(sw.includes('moaru-runtime-bundle-'),'v90 service worker cache missing');
