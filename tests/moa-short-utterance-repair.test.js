...
ok(html.includes('moa-communication-engine.js?v=11'),'engine cache bust v9 missing');
...
(async()=>{
  ...
  const b=await E.reply('등신');ok(/잘못|이상|맥락|제대로|답/.test(String(b.reply||'')),'insult should acknowledge reply failure');
