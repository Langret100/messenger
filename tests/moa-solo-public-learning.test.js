...
for(const token of ['moaPolicyLearningTier_','positive_score','negative_score','evidence_hashes','learning_tier','moa-public-policy-'])ok(gs.includes(token),'public policy learning missing '+token);
