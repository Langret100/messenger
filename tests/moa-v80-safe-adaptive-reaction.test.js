...
ok(html.includes('js/ai/moa-chat-engine.js?v=12')&&html.includes('js/adapters/auth-api.js?v=64.5.30')&&html.includes('js/app.js?v=64.5.36'),'v80 client cache bust missing');
ok(sw.includes('moaru-v64.5.48-moa-conversation-v85-20260820')&&app.includes('sw.js?v=64.5.48'),'v80 service worker cache bump missing');
