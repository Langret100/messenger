...
ok(html.includes('js/ai/moa-communication-engine.js?v=11')&&!html.includes('moa-dialogue-core.js')&&!html.includes('moa-chat-engine.js'),'v87 compatibility engine asset mismatch');
ok(sw.includes('moaru-v64.5.59-admin-delivery-reliability-v100-20260821')&&sw.includes('./js/ai/moa-communication-engine.js'),'v87 compatibility SW asset mismatch');
