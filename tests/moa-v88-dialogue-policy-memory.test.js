...
ok(html.includes('moa-communication-engine.js?v=11'),'v88 cache bust missing');
ok(sw.includes('moaru-v64.5.59-admin-delivery-reliability-v100-20260821'),'v88 service worker cache missing');
...
(async()=>{const e=sandbox.MiniTalk.AI.MoaCommunicationEngine;await e.sync(true);
 ...
 const snap=e.debugSnapshot();ok(snap.version===91&&Array.isArray(snap.state.strategyHistory),'v88 debug/state missing');
