...
ok(html.includes('moa-communication-engine.js?v=9'),'v88 cache bust missing');
ok(sw.includes('moaru-v64.5.50-interaction-weather-popup-v91-20260821'),'v88 service worker cache missing');
