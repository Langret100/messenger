...
ok(html.includes('moa-communication-engine.js?v=6'),'v89 cache bust missing');
ok(sw.includes('moaru-v64.5.49-task-reward-shopping-audit-v91-20260821'),'v89 service worker cache missing');
