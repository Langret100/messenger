...
ok(html.includes('moa-chat.css?v=5')&&html.includes('moa-communication-engine.js?v=9')&&html.includes('moa-chat.js?v=10'),'v90 cache bust missing');
ok(sw.includes('moaru-v64.5.50-interaction-weather-popup-v91-20260821'),'v90 service worker cache missing');
