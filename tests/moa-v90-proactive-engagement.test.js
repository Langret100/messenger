...
ok(html.includes('moa-chat.css?v=6')&&html.includes('moa-communication-engine.js?v=14')&&html.includes('moa-chat.js?v=11'),'v90 cache bust missing');
ok(sw.includes('moaru-v64.5.57-admin-feed-tools-v97-20260821'),'v90 service worker cache missing');
