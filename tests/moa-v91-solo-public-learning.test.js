...
ok(html.includes('moa-communication-engine.js?v=14'),'v91 engine cache bust missing');
ok(sw.includes('moaru-v64.5.57-admin-feed-tools-v97-20260821'),'v91 service worker cache missing');
