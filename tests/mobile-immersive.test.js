...
ok(mob.includes('exitFullscreen')&&mob.includes('toggleFullscreenFromGesture'),'fullscreen exit/toggle is missing');
ok(shell.includes('fullscreen:change')&&shell.includes('전체 화면 종료'),'fullscreen button state sync is missing');
