...
for(const ref of ['shopping-store.css?v=64.5.17','feed-classinfo-weekly.css?v=65.0.31','js/core/registry.js?v=3','js/ui/shell.js?v=64.5.34','friday-grade6-mission.js?v=65.0.19','js/features/tools.js?v=64.5.15','js/features/shopping.js?v=64.5.41'])ok(html.includes(ref),`cache ref missing ${ref}`);
