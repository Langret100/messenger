...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.27')&&html.includes('js/features/feed.js?v=65.0.21')&&html.includes('js/features/auth.js?v=64.5.35')&&html.includes('js/ui/shell.js?v=64.5.33'),'new asset versions stale');
