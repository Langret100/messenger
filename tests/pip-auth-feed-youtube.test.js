...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.16')&&html.includes('js/features/feed.js?v=65.0.10')&&html.includes('js/features/auth.js?v=64.5.34')&&html.includes('js/ui/shell.js?v=64.5.31'),'new asset versions stale');
