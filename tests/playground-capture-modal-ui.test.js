...
ok(html.includes('js/app.js?v=64.5.11'),'stale cache version for js/app.js');
...
ok(sw.includes('moaru-v64.5.12-traffic-final-20260819')&&app.includes('sw.js?v=64.5.11'),'service worker v64.5.12 cache update is missing');
