...
ok(html.includes('js/app.js?v=64.5.43'),'stale cache version for js/app.js');
...
ok(sw.includes('moaru-moa-admin-isolation-url-filter-v10')&&app.includes('sw.js?v=64.5.57'),'service worker v64.5.14 cache update is missing');
