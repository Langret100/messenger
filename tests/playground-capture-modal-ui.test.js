...
ok(html.includes('js/features/chats.js?v=64.5.12'), 'stale cache version for js/features/chats.js');
ok(html.includes('js/features/auth.js?v=64.5.28'),'stale cache version for js/features/auth.js');
ok(html.includes('js/app.js?v=64.5.28'),'stale cache version for js/app.js');
ok(html.includes('css/app.css?v=64.5.7'),'stale cache version for css/app.css');
...
ok(sw.includes('moaru-v64.5.28-login-first-paint-20260819')&&app.includes('sw.js?v=64.5.28'),'service worker v64.5.14 cache update is missing');
