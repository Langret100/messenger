...
ok(html.includes('js/features/tools.js?v=64.5.3'),'stale cache version for js/features/tools.js');
...
ok(sw.includes('moaru-v64.5.60-tools-pip-real-fix-v101-20260821')&&app.includes('sw.js?v=64.5.49'),'service worker v64.5.14 cache update is missing');
