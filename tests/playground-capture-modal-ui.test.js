...
ok(html.includes('js/features/chats.js?v=64.5.18'), 'stale cache version for js/features/chats.js');
...
ok(sw.includes('moaru-v64.5.46-profile-15kb-20260820')&&app.includes('sw.js?v=64.5.46'),'service worker v64.5.14 cache update is missing');
