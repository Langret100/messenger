...
ok(html.includes('js/features/chats.js?v=64.5.23'), 'stale cache version for js/features/chats.js');
...
ok(html.includes('css/app.css?v=64.5.22'),'stale cache version for css/app.css');
