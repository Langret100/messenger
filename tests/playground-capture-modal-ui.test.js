...
ok(html.includes('js/app.js?v=64.5.25'),'stale cache version for js/app.js');
...
ok(sw.includes('moaru-v64.5.25-admin-task-bulk-20260819')&&app.includes('sw.js?v=64.5.25'),'service worker v64.5.14 cache update is missing');
