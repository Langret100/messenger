...
ok(html.includes('js/app.js?v=64.5.5'),'stale cache version for js/app.js');
...
ok(sw.includes('moaru-v64.5.5-stable-shopping-profile-20260818')&&app.includes('sw.js?v=64.5.5'),'service worker v64.5.5 cache update is missing');
