...
ok(html.includes('js/features/chats.js?v=64.5.20'), 'stale cache version for js/features/chats.js');
...
ok(sw.includes('moaru-v64.5.49-task-reward-shopping-audit-v91-20260821')&&app.includes('sw.js?v=64.5.48'),'service worker v64.5.14 cache update is missing');
