...
ok(html.includes('js/app.js?v=64.5.6'),'stale cache version for js/app.js');
...
ok(sw.includes('moaru-v64.5.6-admin-window-realtime-effects-20260818')&&app.includes('sw.js?v=64.5.6'),'service worker v64.5.6 cache update is missing');
