...
ok(html.includes('js/features/tools.js?v=64.5.5'),'stale cache version for js/features/tools.js');
...
ok(sw.includes('moaru-v64.5.63-task-tools-ui-20260821')&&app.includes('sw.js?v=64.5.50'),'service worker v64.5.14 cache update is missing');
