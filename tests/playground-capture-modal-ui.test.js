...
ok(html.includes('js/app.js?v=64.5.15'),'stale cache version for js/app.js');
ok(html.includes('css/app.css?v=64.5.5'),'stale cache version for css/app.css');
ok(html.includes('js/ui/shell.js?v=64.5.7'),'stale cache version for js/ui/shell.js');
...
ok(sw.includes('moaru-v64.5.15-capacity-gate-20260819')&&app.includes('sw.js?v=64.5.15'),'service worker v64.5.14 cache update is missing');
