...
ok(html.includes('js/features/tools.js?v=64.5.4'),'stale cache version for js/features/tools.js');
...
ok(sw.includes('moaru-v64.5.61-dragscroll-cleanup-v102-20260821')&&app.includes('sw.js?v=64.5.49'),'service worker v64.5.14 cache update is missing');
