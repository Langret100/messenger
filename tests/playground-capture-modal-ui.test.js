...
ok(html.includes('js/ui/shell.js?v=64.5.30'),'stale cache version for js/ui/shell.js');
...
ok(sw.includes('moaru-v64.5.35-pip-auth-feed-youtube-20260820')&&app.includes('sw.js?v=64.5.35'),'service worker v64.5.14 cache update is missing');
