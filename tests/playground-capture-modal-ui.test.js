...
ok(html.includes('js/features/chats.js?v=64.5.28'), 'stale cache version for js/features/chats.js');
ok(html.includes('js/features/auth.js?v=64.5.35'),'stale cache version for js/features/auth.js');
ok(html.includes('js/app.js?v=64.5.47'),'stale cache version for js/app.js');
ok(html.includes('css/app.css?v=64.5.23'),'stale cache version for css/app.css');
ok(html.includes('js/ui/shell.js?v=64.5.36'),'stale cache version for js/ui/shell.js');
ok(html.includes('js/tools/profile-editor.js?v=64.4.2'),'stale cache version for js/tools/profile-editor.js');
ok(html.includes('js/features/tools.js?v=64.5.17'),'stale cache version for js/features/tools.js');
...
ok(sw.includes('moaru-runtime-bundle-2')&&app.includes('sw.js?v=64.5.61'),'service worker v64.5.14 cache update is missing');
