...
ok(html.includes('js/app.js?v=64.5.3'),'stale cache version for js/app.js');
ok(html.includes('css/app.css?v=64.5.3'),'stale cache version for css/app.css');
...
ok(sw.includes('moaru-v64.5.3-pwa-window-search-20260818')&&app.includes('sw.js?v=64.5.3'),'service worker v64.5.3 cache update is missing');
...
ok(css.includes(':root[data-window-mode="standalone"] .workspace{grid-template-columns:1fr;grid-template-rows:1fr 50px}')&&css.includes('grid-template-rows:1fr calc(50px + env(safe-area-inset-bottom,0px))'),'bottom navigation remains excessively tall');
