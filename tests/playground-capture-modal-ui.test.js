...
ok(html.includes('js/features/tools.js?v=64.5.11'),'stale cache version for js/features/tools.js');
...
ok(sw.includes('moaru-camera-popup-task-scroll-fix')&&app.includes('sw.js?v=64.5.51'),'service worker v64.5.14 cache update is missing');
