...
ok(html.includes('js/features/chats.js?v=64.5.15'), 'stale cache version for js/features/chats.js');
ok(html.includes('js/features/auth.js?v=64.5.33'),'stale cache version for js/features/auth.js');
ok(html.includes('js/app.js?v=64.5.33'),'stale cache version for js/app.js');
ok(html.includes('css/app.css?v=64.5.10'),'stale cache version for css/app.css');
ok(html.includes('js/ui/shell.js?v=64.5.29'),'stale cache version for js/ui/shell.js');
...
ok(sw.includes('moaru-v64.5.33-pip-session-idle-cache-20260819')&&app.includes('sw.js?v=64.5.33'),'service worker v64.5.14 cache update is missing');
