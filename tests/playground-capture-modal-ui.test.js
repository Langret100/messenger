...
ok(html.includes('js/app.js?v=64.5.18'),'stale cache version for js/app.js');
...
ok(sw.includes('moaru-v64.5.18-wait-ui-20260819')&&app.includes('sw.js?v=64.5.18'),'service worker v64.5.14 cache update is missing');
