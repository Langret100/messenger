...
ok(tools.includes('id: "playground"')&&tools.includes('playground: () => openOnlinePlayground()'),'playground main-tool card or positioned opener is missing');
ok(tools.includes('description: "친구와 온라인으로 놀기"'),'playground short description mismatch');
ok(config.includes('{name:"페이스 체인지",tool:"face-toy"}'),'face change related-link entry is missing');
...
ok(html.includes('js/app.js?v='),'stale cache version for js/app.js');
ok(html.includes('css/app.css?v='),'stale cache version for css/app.css');
ok(html.includes('js/ui/shell.js?v='),'stale cache version for js/ui/shell.js');
ok(html.includes('js/tools/profile-editor.js?v='),'stale cache version for js/tools/profile-editor.js');
ok(html.includes('js/features/tools.js?v='),'stale cache version for js/features/tools.js');
ok(html.includes('js/tools/capture.js?v='),'stale cache version for js/tools/capture.js');
ok(html.includes('js/chat/linkify.js?v='),'stale cache version for js/chat/linkify.js');
ok(html.includes('css/chat-link-capture-polish.css?v='),'chat link polish stylesheet is missing');
ok(sw.includes('moaru-runtime-bundle-')&&app.includes('sw.js?v='),'service worker v64.5.14 cache update is missing');
