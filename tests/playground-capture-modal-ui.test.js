...
ok(html.includes('js/app.js?v=64.5.42'),'stale cache version for js/app.js');
...
ok(sw.includes('moaru-moa-performance-audit-v9')&&app.includes('sw.js?v=64.5.56'),'service worker v64.5.14 cache update is missing');
