...
ok(html.includes('js/features/tools.js?v=64.5.8'),'stale cache version for js/features/tools.js');
...
ok(sw.includes('moaru-face-play-polish')&&app.includes('sw.js?v=64.5.50'),'service worker v64.5.14 cache update is missing');
