...
if(!index.includes("css/app.css?v=")||!index.includes("js/adapters/window-mode.js?v="))throw new Error("PWA layout cache version is stale");
if(!index.includes("js/tools/notifications.js?v=")||!notifications.includes('icon: "assets/icons/moaru-app-192.png"'))throw new Error("notification icon is stale");
