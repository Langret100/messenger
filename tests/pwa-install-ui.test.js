...
if(!index.includes("js/tools/notifications.js?v=64.5.3")||!notifications.includes('icon: "assets/icons/moaru-app-192.png"'))throw new Error("notification icon is stale");
