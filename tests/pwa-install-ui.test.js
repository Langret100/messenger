...
if(!index.includes('manifest.webmanifest?v=64.5.2'))throw new Error("manifest cache version is stale");
if(!index.includes("js/adapters/window-mode.js?v=64.5.2"))throw new Error("window mode cache version is stale");
if(!index.includes("js/tools/notifications.js?v=64.5.2")||!notifications.includes('icon: "assets/icons/moaru-app-192-v6451.png"'))throw new Error("notification icon is stale");
if(!windowMode.includes("STANDALONE_BOUNDS={width:400,height:740}"))throw new Error("standalone preferred bounds missing");
if(!windowMode.includes("requestWindow({width:400,height:740"))throw new Error("PiP preferred bounds missing");
