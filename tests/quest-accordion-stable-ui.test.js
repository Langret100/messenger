...
ok(html.includes('quest-accordion.css?v=26')&&html.includes('drag-scroll.js?v=11')&&html.includes('friday-grade6-mission.js?v=65.0.16'),'quest UI cache refs stale');
