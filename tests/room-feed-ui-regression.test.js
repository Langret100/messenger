...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.20')&&html.includes('realtime.js?v=64.5.37')&&html.includes('features/feed.js?v=65.0.18')&&html.includes('app.js?v=64.5.36'),'room/feed cache versions stale');
