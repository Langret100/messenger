...
const initialPos=rt.indexOf('if(mode==="firebase")loadInitialRooms();');
...
ok(!startFirebase.includes('loadInitialRooms();'),'startFirebase must not trigger member room load while transport is initializing');
