...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.11')&&html.includes('realtime.js?v=64.5.30')&&html.includes('features/feed.js?v=65.0.7')&&html.includes('app.js?v=64.5.31'),'room/feed cache versions stale');
ok(sw.includes('moaru-v64.5.31-room-summary-mobile-chrome-20260819')&&app.includes('sw.js?v=64.5.31'),'service worker cache version stale');
