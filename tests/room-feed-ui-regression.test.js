...
ok(feed.includes('class:"view feed-shell view-enter"')&&feed.includes('class:"feed-view"'),'feed shell and scroll area must be separate');
...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.16')&&html.includes('realtime.js?v=64.5.33')&&html.includes('features/feed.js?v=65.0.12')&&html.includes('app.js?v=64.5.33'),'room/feed cache versions stale');
