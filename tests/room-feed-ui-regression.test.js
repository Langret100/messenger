...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.31')&&html.includes('realtime.js?v=64.5.49')&&html.includes('features/feed.js?v=65.0.21')&&html.includes('app.js?v=64.5.46'),'room/feed cache versions stale');
