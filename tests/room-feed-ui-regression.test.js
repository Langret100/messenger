...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.21')&&html.includes('realtime.js?v=64.5.37')&&html.includes('features/feed.js?v=65.0.18')&&html.includes('app.js?v=64.5.36'),'room/feed cache versions stale');
ok(sw.includes('moaru-v64.5.49-task-reward-shopping-audit-v91-20260821')&&app.includes('sw.js?v=64.5.48'),'service worker cache version stale');
