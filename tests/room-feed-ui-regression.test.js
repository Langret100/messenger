...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.31')&&html.includes('realtime.js?v=64.5.42')&&html.includes('features/feed.js?v=65.0.21')&&html.includes('app.js?v=64.5.42'),'room/feed cache versions stale');
ok(sw.includes('moaru-moa-performance-audit-v9')&&app.includes('sw.js?v=64.5.56'),'service worker cache version stale');
