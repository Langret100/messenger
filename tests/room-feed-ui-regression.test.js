...
ok(html.includes('feed-classinfo-weekly.css?v=')&&html.includes('realtime.js?v=')&&html.includes('features/feed.js?v=')&&html.includes('app.js?v='),'room/feed cache versions stale');
