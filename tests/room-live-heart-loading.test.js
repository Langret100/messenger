...
ok(html.includes('css/app.css?v=')&&html.includes('feed-classinfo-weekly.css?v=')&&html.includes('js/core/router.js')&&html.includes('realtime.js?v=')&&html.includes('js/chat/unread.js')&&html.includes('features/feed.js?v=')&&html.includes('app.js?v='),'v5.23 cache versions stale');
ok(sw.includes('moaru-runtime-bundle-')&&app.includes('sw.js?v='),'v5.23 service worker version stale');
