...
ok(html.includes('css/app.css?v=64.5.13')&&html.includes('feed-classinfo-weekly.css?v=65.0.28')&&html.includes('js/core/router.js')&&html.includes('realtime.js?v=64.5.38')&&html.includes('js/chat/unread.js')&&html.includes('features/feed.js?v=65.0.21')&&html.includes('app.js?v=64.5.37'),'v5.23 cache versions stale');
