...
ok(rt.includes('ref.on("value",onValue')&&rt.includes('memberSummaryUnsubs.set(id'),'member room summaries are not subscribed outside group tab');
...
ok(html.includes('css/app.css?v=64.5.22')&&html.includes('feed-classinfo-weekly.css?v=65.0.31')&&html.includes('js/core/router.js')&&html.includes('realtime.js?v=64.5.45')&&html.includes('js/chat/unread.js')&&html.includes('features/feed.js?v=65.0.21')&&html.includes('app.js?v=64.5.46'),'v5.23 cache versions stale');
