...
ok(html.includes('css/app.css?v=64.5.13')&&html.includes('feed-classinfo-weekly.css?v=65.0.31')&&html.includes('js/core/router.js')&&html.includes('realtime.js?v=64.5.42')&&html.includes('js/chat/unread.js')&&html.includes('features/feed.js?v=65.0.21')&&html.includes('app.js?v=64.5.43'),'v5.23 cache versions stale');
ok(sw.includes('moaru-moa-admin-isolation-url-filter-v10')&&app.includes('sw.js?v=64.5.57'),'v5.23 service worker version stale');
