...
ok(html.includes('css/app.css?v=64.5.11')&&html.includes('feed-classinfo-weekly.css?v=65.0.22')&&html.includes('js/core/router.js')&&html.includes('realtime.js?v=64.5.37')&&html.includes('js/chat/unread.js')&&html.includes('features/feed.js?v=65.0.18')&&html.includes('app.js?v=64.5.36'),'v5.23 cache versions stale');
