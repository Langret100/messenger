...
ok(html.includes('js/adapters/realtime.js?v=64.5.30')&&html.includes('js/adapters/mobile-immersive.js?v=57')&&html.includes('js/features/chats.js?v=64.5.14')&&html.includes('js/app.js?v=64.5.31'),'v5.24 cache versions stale');
ok(sw.includes('moaru-v64.5.31-room-summary-mobile-chrome-20260819')&&app.includes('sw.js?v=64.5.31'),'v5.24 service worker stale');
