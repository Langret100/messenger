...
ok(html.includes('js/adapters/realtime.js?v=64.5.42')&&html.includes('js/adapters/mobile-immersive.js?v=57')&&html.includes('js/features/chats.js?v=64.5.21')&&html.includes('js/app.js?v=64.5.42'),'v5.24 cache versions stale');
ok(sw.includes('moaru-moa-performance-audit-v9')&&app.includes('sw.js?v=64.5.56'),'v5.24 service worker stale');
