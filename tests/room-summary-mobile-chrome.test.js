...
ok(html.includes('js/adapters/realtime.js?v=64.5.33')&&html.includes('js/adapters/mobile-immersive.js?v=57')&&html.includes('js/features/chats.js?v=64.5.15')&&html.includes('js/app.js?v=64.5.33'),'v5.24 cache versions stale');
ok(sw.includes('moaru-v64.5.43-feed-heart-state-audio-reward-20260820')&&app.includes('sw.js?v=64.5.43'),'v5.24 service worker stale');
