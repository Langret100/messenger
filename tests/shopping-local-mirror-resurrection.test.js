...
ok(html.includes('js/shopping/store-service.js?v='), 'store-service cache version stale');
ok(html.includes('js/adapters/realtime.js?v='), 'realtime cache version stale');
