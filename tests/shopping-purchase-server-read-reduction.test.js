...
ok(/createFreshPurchasedInventory_\(userId, inventoryProduct, purchaseKey\); clearPendingShopPurchase_\(purchaseKey\)/.test(s),'fresh purchase completion path missing');
