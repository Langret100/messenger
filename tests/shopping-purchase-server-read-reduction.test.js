...
ok(/createFreshPurchasedInventory_\(userId, inventoryProduct, purchaseKey\)/.test(s)&&/clearPendingShopPurchase_\(purchaseKey, userId\)/.test(s),'fresh purchase completion path missing');
