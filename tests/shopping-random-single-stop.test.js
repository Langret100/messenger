...
const vm=html.match(/js\/features\/shopping\.js\?v=(\d+)\.(\d+)\.(\d+)/);if(!vm||(+vm[1]<64)||(+vm[1]===64&&+vm[2]<5)||(+vm[1]===64&&+vm[2]===5&&+vm[3]<57))throw new Error("shopping cache-bust version was not advanced");
