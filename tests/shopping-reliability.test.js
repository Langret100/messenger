...
if(!html.includes('css/features/shopping-store.css?v=64.5.14')||!html.includes('css/features/display-clarity.css?v=64.5.6')||!html.includes('js/features/shopping.js?v=64.5.33')||!html.includes('js/shopping/store-service.js?v=64.5.16')||!html.includes('js/tasks/daily-math-quest.js?v=64.5.7'))throw new Error('shopping or math cache versions are stale');

if(!service.includes('async function randomPurchase()')||!ui.includes('openRandomPurchase()')||ui.includes('한 번 더 누르면')||!ui.includes('setTimeout(movePrizeToInventory,1350)'))throw new Error('single-spin random purchase client flow is missing');
