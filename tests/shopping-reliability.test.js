...
if(!html.includes('css/features/shopping-store.css?v=64.5.12')||!html.includes('css/features/display-clarity.css?v=64.5.6')||!html.includes('js/features/shopping.js?v=64.5.31')||!html.includes('js/shopping/store-service.js?v=64.5.16')||!html.includes('js/tasks/daily-math-quest.js?v=64.5.7'))throw new Error('shopping or math cache versions are stale');

if(!service.includes('async function randomPurchase()')||!ui.includes('openRandomPurchase()')||!ui.includes('한 번 더 누르면 바로 결과'))throw new Error('random purchase client flow is missing');
