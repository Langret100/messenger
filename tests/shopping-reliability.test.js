...
if(!html.includes('css/features/shopping-store.css?v=')||!html.includes('css/features/display-clarity.css?v=')||!html.includes('js/features/shopping.js?v=')||!html.includes('js/shopping/store-service.js?v=')||!html.includes('js/tasks/daily-math-quest.js?v='))throw new Error('shopping or math cache versions are stale');
