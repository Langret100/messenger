...
if(!html.includes('css/features/shopping-store.css?v=64.5.11')||!html.includes('css/features/display-clarity.css?v=64.5.6')||!html.includes('js/features/shopping.js?v=64.5.29')||!html.includes('js/shopping/store-service.js?v=64.5.14')||!html.includes('js/tasks/daily-math-quest.js?v=64.5.6'))throw new Error('shopping or math cache versions are stale');
