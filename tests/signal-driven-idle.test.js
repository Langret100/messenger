...
for(const ref of ['realtime.js?v=64.5.53','task-service.js?v=64.5.28','features/tasks.js?v=64.5.4','features/admin.js?v=64.5.43','app.js?v=64.5.47'])if(!index.includes(ref))throw new Error(`cache-busted signal-idle asset missing: ${ref}`);
if(!sw.includes('moaru-runtime-bundle-2')||!app.includes('sw.js?v=64.5.61'))throw new Error("signal-idle service worker cache bump missing");
