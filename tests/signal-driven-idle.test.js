...
for(const ref of ['realtime.js?v=64.5.47','task-service.js?v=64.5.26','features/tasks.js?v=64.5.4','features/admin.js?v=64.5.41','app.js?v=64.5.46'])if(!index.includes(ref))throw new Error(`cache-busted signal-idle asset missing: ${ref}`);
