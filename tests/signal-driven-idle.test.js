...
for(const ref of ['realtime.js?v=64.5.42','task-service.js?v=64.5.26','features/tasks.js?v=64.5.4','features/admin.js?v=64.5.32','app.js?v=64.5.37'])if(!index.includes(ref))throw new Error(`cache-busted signal-idle asset missing: ${ref}`);
