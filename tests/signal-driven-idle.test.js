...
for(const ref of ['realtime.js?v=64.5.37','task-service.js?v=64.5.25','features/tasks.js?v=64.5.2','features/admin.js?v=64.5.27','app.js?v=64.5.36'])if(!index.includes(ref))throw new Error(`cache-busted signal-idle asset missing: ${ref}`);
