...
for(const ref of ['realtime.js?v=','task-service.js?v=','features/tasks.js?v=','features/admin.js?v=','app.js?v='])if(!index.includes(ref))throw new Error(`cache-busted signal-idle asset missing: ${ref}`);
if(!sw.includes('moaru-runtime-bundle-')||!app.includes('sw.js?v='))throw new Error("signal-idle service worker cache bump missing");
