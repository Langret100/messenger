...
ok(html.includes('js/features/admin.js?v=64.5.36'),'admin cache-bust missing');
ok(sw.includes('moaru-moa-performance-audit-v9'),'v97 service worker cache missing');
