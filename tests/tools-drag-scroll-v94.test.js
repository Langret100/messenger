...
ok(tools.includes('MiniTalk.UI.DragScroll?.bind?.(list,{allowInteractive:'), 'tools screen interactive drag-scroll binding missing');
...
ok(html.includes('js/features/tools.js?v=64.5.2'), 'tools asset cache-bust missing');
ok(sw.includes('moaru-v64.5.59-admin-delivery-reliability-v100-20260821'), 'v94 SW cache missing');
