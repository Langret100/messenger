...
ok(html.includes('js/features/tools.js?v=64.5.4'), 'tools asset cache-bust missing');
ok(sw.includes('moaru-v64.5.61-dragscroll-cleanup-v102-20260821'), 'v94 SW cache missing');
