...
ok(html.includes('js/features/tools.js?v=64.5.3'), 'tools asset cache-bust missing');
ok(sw.includes('moaru-v64.5.60-tools-pip-real-fix-v101-20260821'), 'v94 SW cache missing');
