...
ok(html.includes('js/features/tools.js?v=64.5.5'), 'tools asset cache-bust missing');
ok(sw.includes('moaru-v64.5.63-task-tools-ui-20260821'), 'v94 SW cache missing');
