...
ok(html.includes('js/features/tools.js?v=64.5.5'),'tools v98 cache ref missing');
ok(html.includes('js/adapters/window-mode.js?v=64.5.38'),'window-mode v98 cache ref missing');
ok(sw.includes('moaru-v64.5.63-task-tools-ui-20260821'),'v98 service-worker cache missing');
