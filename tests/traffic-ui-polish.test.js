...
for(const required of ['feed-classinfo-weekly.css?v=65.0.24','realtime.js?v=64.5.37','friday-grade6-mission.js?v=65.0.12','feed.js?v=65.0.20','features/tools.js?v=64.5'])if(!index.includes(required))throw new Error(`cache-busted asset missing: ${required}`);
if(!sw.includes('moaru-v64.5.52-v92-combined-pip-feed-20260821')||!app.includes('sw.js?v=64.5.48'))throw new Error('service worker cache bump missing');
