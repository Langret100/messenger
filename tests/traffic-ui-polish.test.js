...
for(const required of ['feed-classinfo-weekly.css?v=65.0.25','realtime.js?v=64.5.38','friday-grade6-mission.js?v=65.0.14','feed.js?v=65.0.21','features/tools.js?v=64.5'])if(!index.includes(required))throw new Error(`cache-busted asset missing: ${required}`);
if(!sw.includes('moaru-v64.5.62-admin-fastpath-v104-20260821')||!app.includes('sw.js?v=64.5.49'))throw new Error('service worker cache bump missing');
