...
for(const required of ['feed-classinfo-weekly.css?v=65.0.31','realtime.js?v=64.5.53','friday-grade6-mission.js?v=65.0.21','feed.js?v=65.0.21','features/tools.js?v=64.5'])if(!index.includes(required))throw new Error(`cache-busted asset missing: ${required}`);
if(!sw.includes('moaru-runtime-bundle-2')||!app.includes('sw.js?v=64.5.61'))throw new Error('service worker cache bump missing');
