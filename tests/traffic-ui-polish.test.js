...
for(const required of ['feed-classinfo-weekly.css?v=','realtime.js?v=','friday-grade6-mission.js?v=','feed.js?v=','features/tools.js?v='])if(!index.includes(required))throw new Error(`cache-busted asset missing: ${required}`);
if(!sw.includes('moaru-runtime-bundle-')||!app.includes('sw.js?v='))throw new Error('service worker cache bump missing');
