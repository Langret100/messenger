...
for(const required of ['feed-classinfo-weekly.css?v=65.0.31','realtime.js?v=64.5.42','friday-grade6-mission.js?v=65.0.19','feed.js?v=65.0.21','features/tools.js?v=64.5'])if(!index.includes(required))throw new Error(`cache-busted asset missing: ${required}`);
if(!sw.includes('moaru-moa-admin-isolation-url-filter-v10')||!app.includes('sw.js?v=64.5.57'))throw new Error('service worker cache bump missing');
