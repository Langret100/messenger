...
for(const required of ['feed-classinfo-weekly.css?v=65.0.14','realtime.js?v=64.5.33','friday-grade6-mission.js?v=65.0.4','feed.js?v=65.0.8','features/tools.js?v=64.5'])if(!index.includes(required))throw new Error(`cache-busted asset missing: ${required}`);
if(!sw.includes('moaru-v64.5.36-shop-manager-sheet-scale-20260820')||!app.includes('sw.js?v=64.5.36'))throw new Error('service worker cache bump missing');
