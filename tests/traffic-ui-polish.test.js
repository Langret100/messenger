...
for(const required of ['feed-classinfo-weekly.css?v=65.0.12','realtime.js?v=64.5.33','friday-grade6-mission.js?v=65.0.3','feed.js?v=65.0.7','features/tools.js?v=64.5'])if(!index.includes(required))throw new Error(`cache-busted asset missing: ${required}`);
if(!sw.includes('moaru-v64.5.33-pip-session-idle-cache-20260819')||!app.includes('sw.js?v=64.5.33'))throw new Error('service worker cache bump missing');
