...
for(const required of ['feed-classinfo-weekly.css?v=65.0.9','realtime.js?v=64.5.26','friday-grade6-mission.js?v=65.0.3','feed.js?v=65.0.7','features/tools.js?v=64.5'])if(!index.includes(required))throw new Error(`cache-busted asset missing: ${required}`);
if(!sw.includes('moaru-v64.5.26-room-feed-ui-fix-20260819')||!app.includes('sw.js?v=64.5.26'))throw new Error('service worker cache bump missing');
