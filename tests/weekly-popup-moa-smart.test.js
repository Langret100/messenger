...
ok(html.includes('friday-grade6-mission.js?v=65.0.21'),'weekly popup cache-bust missing');
ok(sw.includes('moaru-runtime-bundle-2'),'v92 service worker cache id missing');
