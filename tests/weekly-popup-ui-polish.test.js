...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.31')&&html.includes('js/game-bridge/game-host.js?v=24')&&html.includes('js/tasks/friday-grade6-mission.js?v=65.0.19')&&html.includes('js/tasks/task-window.js?v=64.5.10')&&html.includes('js/features/admin.js?v=64.5.41'),'new UI cache versions missing');
