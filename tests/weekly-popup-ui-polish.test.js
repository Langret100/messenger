...
ok(html.includes('feed-classinfo-weekly.css?v=65.0.22')&&html.includes('js/game-bridge/game-host.js?v=23')&&html.includes('js/tasks/friday-grade6-mission.js?v=65.0.11')&&html.includes('js/tasks/task-window.js?v=64.5.9')&&html.includes('js/features/admin.js?v=64.5.27'),'new UI cache versions missing');
