...
ok(html.includes('friday-grade6-mission.js?v=65.0.15'),'weekly v96 cache bust missing');
ok(sw.includes('moaru-v64.5.63-task-tools-ui-20260821'),'weekly v96 service worker id missing');
