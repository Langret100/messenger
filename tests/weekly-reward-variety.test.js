...
ok(html.includes('friday-grade6-mission.js?v=65.0.17'),'weekly v96 cache bust missing');
ok(sw.includes('moaru-tools-scroll-layout'),'weekly v96 service worker id missing');
